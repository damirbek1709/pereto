...
use app\models\LibraryCategorySearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * LibraryCategoryController implements the CRUD actions for LibraryCategory model.
 */
class LibraryCategoryController extends Controller
{
    ...
    {
        $searchModel = new LibraryCategorySearch();
    ...
    /**
     * Displays a single LibraryCategory model.
     * @param int $id ID
     * @return mixed
